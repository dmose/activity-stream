...
function template(rawOptions) {
  ...
  const csp = options.csp === "on" ?
    "<meta http-equiv=\"Content-Security-Policy\" content=\"default-src 'none'; script-src 'self'; img-src http: https: data: chrome://favicon/; style-src 'self' 'unsafe-inline'; child-src 'self' https://*.youtube.com https://*.vimeo.com; frame-src 'self' https://*.youtube.com https://*.vimeo.com\">" :
    "";
  return `<!doctype html>
<html lang="en-us">
  <head>
